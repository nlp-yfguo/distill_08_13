...
root_dir = "/home/yfguo/Data_Cache/"

group_id = "std_A04_B1"

run_id = "teacher_daoshu/fastloss"

data_id = "wmt16cache/rs_6144"

exp_dir = "expm/"
cache_dir = "wmt16/"

train_data = root_dir + cache_dir + data_id + "/train.h5"
dev_data = root_dir + cache_dir + data_id + "/dev.h5"
test_data =root_dir +  cache_dir + data_id + "/test.h5"

fine_tune_m = None

fine_tune_teach = "/home/yfguo/transformer_For_distill/Trans_for_distill/expm/wmt16cache/rs/std/daoshu/avg.h5"
fine_tune_student = "/home/yfguo/transformer_For_distill/Trans_for_distill/expm/wmt16cache/rs/std/base/avg.h5"
