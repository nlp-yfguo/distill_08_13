...
class distillloss(_Loss):
    ...
    def forward(self, cross_loss, teach_out_softmax_withoutT, stu_out_softmax_withoutT,
                teach_out_sotfmax_byT, stu_out_sotfmax_byT, teach_out, stu_out, target, use_fast=True, mask=None, **kwargs):
        # 两个软标签
        ...
        TF_target_sub = torch.le(target_sub_prob, 0.2)  # TF_target_sub = [bsize,seql-1,1],<0.2的置为True
